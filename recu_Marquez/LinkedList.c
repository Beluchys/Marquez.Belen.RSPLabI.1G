...
LinkedList* ll_filter(LinkedList *this, int (*pFunc)(void*))
{
    ...
    if (this != NULL && *pFunc != NULL)
    {
        ...
        {
            tam = ll_len(this); //guardo el tam de la lista original
...
/** \brief Ordena los elementos de la lista utilizando las 2 funciones criterio recibida
 *
 * \param void*
 * \param void*
